...
```
Build and deploy a Streamlit in Snowflake application called RETAILMAX_INSIGHTS_APP. The application must include interactive charts to analyze the data through the lens of the semantic view provided by the Cortex Agent.
